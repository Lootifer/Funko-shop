const footerCopy = {
  ...
  nl: {
    ...
    contact: "Contact",
    checkout: "Afrekenen",
    shipping: "Verzending & verpakking",
    terms: "Voorwaarden",
...
export const createFooter = () => {
  ...
  if (typeof queueMicrotask === "function") {
    queueMicrotask(() => updateFooterLanguage());
  }
  ...
  return `
    <footer id="footer" class="footer premium-footer reveal v45-footer">
      ...
      <div class="footer-brand-block">
        <a
          class="brand footer-brand v45-footer-brand"
          href="index.html"
          aria-label="2nd Life Toys home"
        >
          <img
        ...
        <span
          class="footer-private-label"
          data-footer-copy="private"
        >
          ${copy.private}
        </span>
      </div>
      ...
      <div class="footer-column">
        ...
        <a href="all-products.html" data-footer-copy="all">
          ${copy.all}
        </a>

        <a href="wishlist.html" data-footer-copy="wishlist">
          ${copy.wishlist}
        </a>

        <a href="cart.html" data-footer-copy="cart">
          ${copy.cart}
        </a>
      </div>
      ...
      <div class="footer-column">
        ...
        <a href="contact.html" data-footer-copy="contact">
          ${copy.contact}
        </a>

        <a href="checkout.html" data-footer-copy="checkout">
          ${copy.checkout}
        </a>

        <a href="shipping.html" data-footer-copy="shipping">
          ${copy.shipping}
        </a>

        <a href="terms.html" data-footer-copy="terms">
          ${copy.terms}
        </a>
        ...
        <a
          href="https://www.instagram.com/2nd_life_toys.nl/"
          target="_blank"
